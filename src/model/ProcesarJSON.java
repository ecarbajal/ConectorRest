...
//		        System.out.println("Es objeto");
		        ...
		        while (iter.hasNext()) {
		            ...
		            rfcReceptor = ((entrada.getKey().equals("rfcReceptor") && rfcReceptor == null) ? entrada.getValue().toString() : rfcReceptor);
		            
		            if(serieCFD != null && folioCFD != null && timestamp != null && TSExpedicionCFD != null && status != null
		            		&& TSTimbrado != null && uuid != null && rfcReceptor != null && continuar) {
